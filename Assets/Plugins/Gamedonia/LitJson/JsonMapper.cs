    ...
    public class JsonMapper
    {
        ...
        private static void AddObjectMetadata (Type type)
        {
            ...
            foreach (PropertyInfo p_info in type.GetProperties ()) {
                if (p_info.Name == "Item") {
					...
					//if (data.IsDictionary && data.ElementType == typeof(object)) {
						//data.ElementType = Dictionary<string,object>;
					//	data.ElementType = typeof(Dictionary<string,object>);
					//}
                    continue;
                }
        ...
        private static object ReadValue (Type inst_type, JsonReader reader)
        {
            ...
            if (reader.Token == JsonToken.ArrayStart) {
				...
				//AXM correccion del parser
				if (reader.parser_in_map && inst_type == typeof(object)) {
                ...
                while (true) {
                    ...
                    if (t_data.Properties.ContainsKey (property)) {
						...
						reader.parser_in_map = true;
                        ((IDictionary) instance).Add (
                            property, ReadValue (
                                t_data.ElementType, reader));
						reader.parser_in_map = false;
